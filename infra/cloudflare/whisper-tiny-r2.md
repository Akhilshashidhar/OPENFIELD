...
shared caption-model R2 bucket (currently served from `media.openreel.video`,
inherited from upstream — see `apps/web/src/workers/whisper-worker.ts`). Two
quality tiers are mirrored:
