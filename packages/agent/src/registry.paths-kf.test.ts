...
import type { MotionShapePathPoint } from "@openfield/core/motion/motion-shape-path";
import { parseMotionPathSegments } from "@openfield/core/motion/motion-shape-path";
