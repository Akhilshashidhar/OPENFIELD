    ...
    >
      ...
      <div className="flex items-center h-12 px-4 gap-4 bg-bg-1 border-b border-border shrink-0 relative z-50">
        <TLTool
          onClick={undo}
          disabled={!canUndo()}
          title={canUndo() ? "Undo (⌘Z)" : "Undo (⌘Z) — nothing to undo yet"}
        >
        ...
        <TLTool
          onClick={redo}
          disabled={!canRedo()}
          title={canRedo() ? "Redo (⇧⌘Z)" : "Redo (⇧⌘Z) — nothing to redo"}
        >
        ...
        <TLTool
          ...
          title={
            splittableSelectedClipIds.length === 0
              ? "Split (S) — select a clip and place the playhead over it"
              : "Split (S)"
          }
        >
        ...
        <TLTool
          ...
          title={
            splittableSelectedClipIds.length === 0
              ? "Trim start (Q) — select a clip first"
        ...
        <TLTool
          ...
          title={
            splittableSelectedClipIds.length === 0
              ? "Trim end (W) — select a clip first"
        ...
        <TLTool
          ...
          title={
            selectedClipIds.length === 0
              ? "Delete (Del) — select a clip first"
              : "Delete (Del)"
          }
        >
        ...
        <TLTool
          ...
          title={
            selectedClipIds.length === 0
              ? "Duplicate (⌘D) — select a clip first"
              : "Duplicate (⌘D)"
          }
        >
        ...
        <TLTool
          ...
          title={
            canRippleDelete
              ? "Ripple delete (⇧Del)"
              : "Ripple delete (⇧Del) — select a clip first"
          }
        >
